...
const errorMessages: Record<string, string> = {
  ...
  "CONSOLE-003":
    "게이트웨이 응답 형식이 올바르지 않습니다.",
  "CONSOLE-004":
    "게이트웨이가 요청을 처리하지 못했습니다.",
  "CONSOLE-005":
    "프로바이더 목록을 불러오지 못했습니다.",
  "CONSOLE-006":
    "가드레일 테스트를 완료하지 못했습니다.",
  ...
  "APIKEY-001": "API 키가 올바르지 않습니다.",
  "APIKEY-004": "같은 이름의 API 키가 이미 있습니다.",
  "APIKEY-006": "API 키를 찾을 수 없습니다. 목록을 새로고침하세요.",
  "APIKEY-008": "폐기된 API 키는 수정할 수 없습니다.",
  "APIKEY-009": "만료된 API 키는 수정할 수 없습니다.",
  "APIKEY-010": "API 키 만료 시각은 현재보다 이후여야 합니다.",
  ...
  "GUARDRAIL-011":
    "다른 변경이 먼저 저장되었습니다. 최신 초안을 불러오세요.",
  ...
  "GUARDRAIL-018":
    "모델 판정은 마스킹할 위치를 제공하지 않습니다. 차단 또는 허용을 쓰거나 마스킹은 정규식 검사를 사용하세요.",
  "PROXY-001": "테스트할 가드레일을 지정하세요.",
  "PROXY-002": "테스트할 모델을 선택하세요.",
  INTERNAL: "게이트웨이가 요청을 처리하지 못했습니다.",
  VALIDATION: "입력 내용을 확인하세요.",
  NOT_FOUND: "요청한 항목을 찾을 수 없습니다. 목록을 새로고침하세요.",
  UNAUTHORIZED: "세션이 만료되었습니다. 다시 로그인하세요.",
  FORBIDDEN: "이 작업을 수행할 권한이 없습니다.",
  CONFLICT: "현재 상태와 충돌했습니다. 최신 내용을 불러오세요.",
};
...
export function consoleErrorMessage(
  ...
  if (error.httpStatus === 409) {
    return "현재 상태와 충돌했습니다. 최신 내용을 불러오세요.";
  }
  if (error.httpStatus === 422) return "입력 내용을 확인하세요.";
